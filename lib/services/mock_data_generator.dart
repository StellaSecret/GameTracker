  ...
  static AppData generate() {
    ...
    game2.sessions = [
      GameSession(
          id: 's4',
          mode: GameMode.points,
          scores: {'p1': 20, 'p2': 25, 'p3': 15, 'p4': 18},
          playedAt: DateTime.now().subtract(const Duration(days: 5))),
      GameSession(
          id: 's5',
          mode: GameMode.points,
          scores: {'p1': 22, 'p2': 21, 'p3': 19, 'p4': 24},
    ...
    game3.sessions = [
      GameSession(
          id: 's6',
          mode: GameMode.points,
          scores: {'p1': 12, 'p2': 4, 'p3': 8, 'p4': 20},
          playedAt: DateTime.now().subtract(const Duration(hours: 12))),
      GameSession(
          id: 's7',
          mode: GameMode.points,
          scores: {'p1': 6, 'p2': 14, 'p3': 3, 'p4': 11},
